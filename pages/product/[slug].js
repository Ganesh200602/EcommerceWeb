...
const Post = ({ error, addToCart, variant, product, buyNow }) => {
  ...
  const refreshVariant = (newSize, newColor) => {
    // console.log(variant, product, newSize);
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                  ...
                  {Object.keys(variant).includes("black") &&
                    Object.keys(variant["black"]).includes(size) && (
                      <button
                        ...
                        className={`border-2  bg-black-700 rounded-full w-6 h-6 focus:outline-none ${
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    ...
                    >
                      {color && Object.keys(variant[color]).includes("S") && (
                        <option value={"S"}>S</option>
                      )}
                      {color && Object.keys(variant[color]).includes("M") && (
                        <option value={"M"}>M</option>
                      )}
                      {color && Object.keys(variant[color]).includes("L") && (
                        <option value={"L"}>L</option>
                      )}
                      {color && Object.keys(variant[color]).includes("XL") && (
                        <option value={"XL"}>XL</option>
                      )}
                      {color && Object.keys(variant[color]).includes("XXL") && (
